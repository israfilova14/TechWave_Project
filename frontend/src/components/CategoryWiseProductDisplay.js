                            ...
                            <div className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow '>
                                ...
                                <div className='p-4 grid gap-3'>
                                    ...
                                    <div className='flex gap-3'>
                                        <p className='text-orange-500 font-medium p-1 animate-pulse rounded-full bg-slate-200 w-full  py-2'></p>
                    ...
                    data.map((product,index)=>{
                        return(
                            <Link to={"/product/"+product?._id} className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow '>
                                ...
                                <div className='p-4 grid gap-3'>
                                    <h2 className='font-medium text-base md:text-lg text-ellipsis line-clamp-1 text-black hover:'>{product?.productName}</h2>
                                    ...
                                    <button className='text-sm bg-orange-400 hover:bg-orange-500 text-white px-3 py-0.5 rounded-full' onClick={(e)=>handleAddToCart(e,product?._id)}>Add to Cart</button>
                                </div>
                            </Link>
                        )
                    })
